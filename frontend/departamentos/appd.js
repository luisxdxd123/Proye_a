document.addEventListener("DOMContentLoaded", () => {
    const btnAgregar = document.getElementById("btnSolicitudes");
    const btnEliminar = document.getElementById("btnSolicitudesEnviadas");
    const btnModificar = document.getElementById("btnSolictudesAutorizadas");
