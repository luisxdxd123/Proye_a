...
<body>
  <nav class="sidebar">
    ...
    <ul class="sidebar-links">
      <li>
        <button id="btnAgregar" type="button">Agregar Usuario</button>
      </li>
      <li>
        <button id="btnEliminar" type="button">Eliminar Usuario</button>
      </li>
      <li>
        <button id="btnModificar" type="button">Modificar Usuario</button>
      </li>
    </ul>
