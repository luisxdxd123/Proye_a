...
<div class="bg-[#6B1024] text-white w-64 flex-shrink-0 fixed h-screen overflow-y-hidden">
    ...
    <nav class="mt-6">
        <a href="#" id="inicio-tab" class="block px-4 py-3 hover:bg-[#8B223A] transition-colors duration-200 border-l-4 border-transparent hover:border-white">
        ...
        <a href="#" id="reportes-tab" class="block px-4 py-3 hover:bg-[#8B223A] transition-colors duration-200 border-l-4 border-transparent hover:border-white">
            <div class="flex items-center space-x-3">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
