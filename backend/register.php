...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO usuarios (nombre, apellido, fecha_nacimiento, genero, contacto, contrasena, rol_user) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    try {
        $stmt->execute([$nombre, $apellido, $fecha_nacimiento, $genero, $contacto, $contrasena, $rol_user]);
